...
public class SerializeUtils {
     ...
     */
    public static SerializeService getSerializeService(SerializeTypeEnum serializeType, SerializeService defaultSerializationService) {
    ...
    public static SerializeService getSerializeService(int value, SerializeService defaultSerializationService) {
        SerializeTypeEnum serializeType = SerializeTypeEnum.getSerializeTypeByValue(value);
